...
class Products extends model {
	...
	public function getAvailableValuesFromOptions($groups, $ids) {
		...
		$sql = "SELECT p_value, id_option, COUNT(id_option) as c FROM products_options WHERE id_option IN ('".implode("','", $groups)."') AND id_product IN ('".implode("','", $ids)."') GROUP BY p_value ORDER BY id_option";

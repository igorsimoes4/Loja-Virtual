		...
		<nav class="navbar topnav">
			<div class="container">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#"><img class="image_language" src="<?php echo BASE_URL; ?>assets/images/<?php $this->lang->get('LANGUAGE'); ?>.png"> <?php $this->lang->get('LANGUAGE'); ?>
						<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo BASE_URL; ?>lang/set/en"><img class="image_language" src="<?php echo BASE_URL; ?>assets/images/English.png"> English</a></li>
							<li><a href="<?php echo BASE_URL; ?>lang/set/pt-br"><img class="image_language" src="<?php echo BASE_URL; ?>assets/images/Português.png"> Português</a></li>
							<li><a href="<?php echo BASE_URL; ?>lang/set/es"><img class="image_language" src="<?php echo BASE_URL; ?>assets/images/Español.png"> Espanhol</a></li>
						</ul>
					</li>
					...
					<div class="col-sm-7">
						...
						<div class="search_area">
							<form action="<?php echo BASE_URL; ?>busca" method="GET">
								<input type="text" name="s" required value="<?php echo (!empty($viewData['searchTerm']))?$viewData['searchTerm']:''; ?>" placeholder="<?php $this->lang->get('SEARCHFORANITEM'); ?>" />
								<select name="category">
									<option value=""><?php $this->lang->get('ALLCATEGORIES'); ?></option>
									<?php foreach($viewData['categories'] as $cat): ?>
										<option <?php echo ((!empty($viewData['category']))&&($viewData['category']==$cat['id']))?'selected="selected"':''; ?> value="<?php echo $cat['id']; ?>">
											<?php echo $cat['name']; ?>
										</option>
						...
						<a href="<?php echo BASE_URL; ?>cart">
							<div class="cartarea">
								...
								<div class="carttotal">
									...
									<span><?php $this->lang->get('COIN'); ?> <?php echo number_format($viewData['cart_subtotal'], 2, ',', '.'); ?></span>
								</div>
							</div>
						</a>
					</div>
			...
			<nav class="navbar">
				<div class="container">
					<ul class="nav navbar-nav">
					    ...
					    <?php if(isset($viewData['category_filters'])): ?>
					      <?php foreach($viewData['category_filters'] as $cf): ?>
	    		...
	    		<div class="container">
	    			<div class="row">
						<div class="col-xs-12 col-sm-8 col-sm-offset-2 no-padding">
							...
							<form action="https://wordpress.us20.list-manage.com/subscribe/post?u=a92a8dea3d940e4082b1e1d65&amp;id=be8bc728c9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
							 	<input type="email" value="" name="EMAIL" placeholder="<?php $this->lang->get('SUBSCRIBETEXT'); ?>" class="subemail required email" id="mce-EMAIL">
							    <input type="hidden" name="b_a92a8dea3d940e4082b1e1d65_be8bc728c9" tabindex="-1" value="">
	    			...
	    			<div class="row">
						...
						<div class="col-sm-6">
							<div class="payments">
								...
								<img src="<?php echo BASE_URL; ?>assets/images/boleto.png" />
								<img src="<?php echo BASE_URL; ?>assets/images/mercado_pago.jpg" />
							</div>
						</div>
					</div>
	    		</div>

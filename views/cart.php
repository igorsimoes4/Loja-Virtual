...
<table border="0" width="100%" style="text-aling:center">
	...
	?>
		<tr>
			...
			<td><a href="<?php echo BASE_URL; ?>cart/del/<?php echo $item['id']; ?>"><img src="<?php echo BASE_URL; ?>assets/images/x-button.png" width="20" /></a></td>
		</tr>
	<?php endforeach; ?>
	<tr>
...
CEP DE ENTREGA: 
	<form method="POST">
		<div class="cep">
			...
			<input type="submit" value="Calcular Frete" class="form-control btn-primary" width="150">
		</div>
	</form>
<hr/>
		...
		<div class="row">
			...
			<div class="col-sm-5">
				...
				<select name="payment_type" class="form-control" style="border-radius: 40px;">
					<option value="escolherpg" style="border-radius: 40px;">Escolher Meio de Pagamento</option>
